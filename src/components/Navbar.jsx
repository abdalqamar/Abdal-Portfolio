    ...
    return (
        <div className="w-full mx-auto">
            ...
            <nav
                ...
                ${isScrolled ? 'bg-[#FAF3EE] backdrop-blur-lg border-b border-neutral-400/80 bg-opacity-90 shadow-sm  ' : 'bg-transparent'}`}
            >
                <a href="#">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button className="block md:hidden ml-3" onClick={menuHandler}>
                        <img src={toggle ? assets.menu_black : assets.menu_black} alt="menu"
                            className="w-6 cursor-pointer transition" />
                    </button>
                </div>

                {/* Mobile Menu */}
                <ul className={`fixed top-0 bottom-0 w-50 h-screen bg-[#FAF3EE]
                 transition-all duration-500 px-5 items-center py-20 z-50 
                    ${toggle ? "right-0" : "-right-60"} flex md:hidden flex-col gap-4`}>

                    <div className="absolute right-6 top-6">
                        <img src={assets.close_black} className=" w-5 cursor-pointer"
                            onClick={menuHandler} />
                    </div>

                    <li><a href="#home" onClick={menuHandler}>Home</a></li>
                    <li><a href="#about" onClick={menuHandler}>About</a></li>
                    <li><a href="#services" onClick={menuHandler}>Services</a></li>
                    <li><a href="#project" onClick={menuHandler}>Projects</a></li>
                    <li><a href="#contact" onClick={menuHandler}>Contact me</a></li>

                    {/* Social Icons */}
                    <div className="flex items-center w-full justify-evenly gap-2 mt-4">
                        <li>
                            <a href="https://facebook.com" className="text-lg cursor-pointer"
                                target="/">
                                <FaFacebook size={23} />
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="//www.instagram.com/abdalqamar24/"
                                target="/" className="text-lg cursor-pointer">
                                <FaInstagram size={23} />
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="https://github.com/abdalqamar" className="text-lg cursor-pointer">
                                <FaGithub size={23} />
                            </a>
                        </li>
                    </div>
